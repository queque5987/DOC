...
ACDoor::ACDoor()
{
	...
	//SMC_Door->SetCollisionObjectType(ECollisionChannel::ECC_EngineTraceChannel2);
	//SMC_Door->SetCollisionResponseToAllChannels(ECollisionResponse::ECR_Block);
	...
	SMC_Door->SetCollisionResponseToChannel(ECollisionChannel::ECC_GameTraceChannel1, ECollisionResponse::ECR_Block);
	SMC_DoorStamp->SetCollisionResponseToChannel(ECollisionChannel::ECC_GameTraceChannel1, ECollisionResponse::ECR_Block);
}
...
void ACDoor::Interact(IIPlayerControllerUI* PlayerControllerUI, IIPlayerControllerStage* PlayerControllerStage)
{
	...
	FVector PlayerDir = (GetActorLocation() - PlayerControllerStage->GetPlayerLocation()).GetSafeNormal2D();
...
void ACDoor::ManualInteract(int32 OpenState)
{
