...
ACGeneratedStair::ACGeneratedStair() : Super()
{
	...
	EntranceCollider->SetCollisionResponseToChannel(COLLISION_CHANNEL_PLAYER_GAZE, ECollisionResponse::ECR_Ignore);
	ExitCollider->SetCollisionResponseToChannel(COLLISION_CHANNEL_PLAYER_GAZE, ECollisionResponse::ECR_Ignore);
}
