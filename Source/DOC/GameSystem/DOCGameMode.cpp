...
ADOCGameMode::ADOCGameMode()
{
	...
	//if (ItemAssets[INTERACTABLE_ITEM_POTION_BLUE]) ItemAssets[INTERACTABLE_ITEM_POTION_BLUE]->ItemCode = INTERACTABLE_ITEM_POTION_BLUE;
	//if (ItemAssets[INTERACTABLE_ITEM_POTION_GREEN]) ItemAssets[INTERACTABLE_ITEM_POTION_GREEN]->ItemCode = INTERACTABLE_ITEM_POTION_GREEN;
	//if (ItemAssets[INTERACTABLE_ITEM_GEMSTONE_BLUE]) ItemAssets[INTERACTABLE_ITEM_GEMSTONE_BLUE]->ItemCode = INTERACTABLE_ITEM_GEMSTONE_BLUE;
	//if (ItemAssets[INTERACTABLE_ITEM_GEMSTONE_YELLOW]) ItemAssets[INTERACTABLE_ITEM_GEMSTONE_YELLOW]->ItemCode = INTERACTABLE_ITEM_GEMSTONE_YELLOW;
	//if (ItemAssets[INTERACTABLE_ITEM_GEMSTONE_RED]) ItemAssets[INTERACTABLE_ITEM_GEMSTONE_RED]->ItemCode = INTERACTABLE_ITEM_GEMSTONE_RED;
	//if (ItemAssets[INTERACTABLE_ITEM_GEMSTONE_GREEN]) ItemAssets[INTERACTABLE_ITEM_GEMSTONE_GREEN]->ItemCode = INTERACTABLE_ITEM_GEMSTONE_GREEN;
	//if (ItemAssets[INTERACTABLE_ITEM_GEMSTONE_PURPLE]) ItemAssets[INTERACTABLE_ITEM_GEMSTONE_PURPLE]->ItemCode = INTERACTABLE_ITEM_GEMSTONE_PURPLE;
